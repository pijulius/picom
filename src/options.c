...
static const struct picom_option picom_options[] = {
    ...
    [345] = {"inner-border-width"          , INTEGER(inner_border_width, 0, INT_MAX)        , "Draw border inside windows with the defined brightness (default 0)"},
    [346] = {"inner-border-brightness"     , FLOAT(inner_border_brightness, 0, INFINITY)    , "Brightness for the inner borders (default 0.89)"},
